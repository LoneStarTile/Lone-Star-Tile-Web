...
export default function LaptopPreviewLanding() {
  return (
    <div className="bg-[#fffae7] relative size-full" data-name="Laptop Preview Landing">
      ...
      <FtPic2 />
      <Group />
      <p className="-translate-x-full absolute font-['Switzer_Variable:Extrabold',sans-serif] font-extrabold leading-[48px] left-[calc(58.33%+522px)] text-[40px] text-black text-right top-[3165px] tracking-[0.8px] w-[433px]">Here’s a Project Portfolio Preview</p>
